...
class Ui_part_2_register_page(object):
    ...
    def next_page(self):
        ...
        birthday = self.birthdate_dateEdit.date().toString("yyyy-MM-dd")
        print(sex, birthday)
        ...
        if(weight == "" or height == ""):
                ...
                data = Register(self.name, self.email, self.password, weight, height, sex, birthday)
                data.user_register()
                update = Login(self.email, self.password)
                update.user_login()
                update.set_user_birthdate(self.name, birthday)
                update.set_user_gender(self.name, sex)
...
"QComboBox { background-color: white; color : black;}")
        ...
        self.sex_comboBox.addItem(icon, "male")
...
"")
    ...
    def retranslateUi(self, part_2_register_page):
        ...
        self.sex_comboBox.setItemText(2, QtWidgets.QApplication.translate("part_2_register_page", "-", None, -1))
        self.sex_label_2.setText(QtWidgets.QApplication.translate("part_2_register_page", "BIRTHDATE", None, -1))
        self.birthdate_dateEdit.setDisplayFormat(QtWidgets.QApplication.translate("part_2_register_page", "yyyy-MM-dd", None, -1))
