...
#
# Created: Sun May  5 21:46:55 2019
...
"")
        ...
        self.orange_background.setGeometry(QtCore.QRect(0, 0, 1920, 1080))
...
"")
        ...
        self.create_an_account_Button.setGeometry(QtCore.QRect(1520, 70, 347, 61))
        font = QtGui.QFont()
...
"")
        ...
        self.welcome_back_label.setGeometry(QtCore.QRect(798, 205, 361, 60))
        font = QtGui.QFont()
        ...
        self.description_label.setGeometry(QtCore.QRect(398, 290, 1154, 67))
        font = QtGui.QFont()
...
"")
        ...
        self.email_label.setGeometry(QtCore.QRect(706, 404, 191, 39))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        ...
        self.email_input.setGeometry(QtCore.QRect(706, 475, 535, 50))
        font = QtGui.QFont()
        ...
        self.password_label.setGeometry(QtCore.QRect(706, 572, 231, 39))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        font.setPointSize(20)
        ...
        self.password_input.setGeometry(QtCore.QRect(706, 630, 535, 50))
        font = QtGui.QFont()
        ...
        self.forget_password_label = QtWidgets.QLabel(login_page)
        self.forget_password_label.setGeometry(QtCore.QRect(915, 576, 340, 30))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        ...
        font.setBold(True)
        self.forget_password_label.setFont(font)
        self.forget_password_label.setCursor(QtCore.Qt.PointingHandCursor)
        self.forget_password_label.setStyleSheet("color : blue;\n"
"background: transparent;\n"
"\n"
"")
        self.forget_password_label.setObjectName("forget_password_label")
        self.log_in_Button = QtWidgets.QPushButton(login_page)
        self.log_in_Button.clicked.connect(self.log_in_to_your_account)
        self.log_in_Button.setGeometry(QtCore.QRect(706, 720, 535, 61))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        font.setPointSize(22)
...
"border-radius : 30px;")
        ...
        self.need_an_account_label.setGeometry(QtCore.QRect(706, 838, 275, 39))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        font.setPointSize(20)
        ...
        self.create_your_account_label.setGeometry(QtCore.QRect(1000, 842, 291, 30))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
...
"")
    ...
    def retranslateUi(self, login_page):
        ...
        self.forget_password_label.setText(QtWidgets.QApplication.translate("login_page", " FORGOT YOUR PASSWORD", None, -1))
